...
| &nbsp; [OIDC Authentication](Authentication.md#oidc-authentication)| <ul><li>[x] </li></ul> | <ul><li>[x] </li></ul>
| &nbsp; [Service Accounts](Authentication.md#service-accounts)| <ul><li>[x] </li></ul> | <ul><li>[x] </li></ul>
| &nbsp; ['global' Basic Auth](Authentication.md#global-basic-auth)| <ul><li>[ ] </li></ul> | &nbsp; Configurable
